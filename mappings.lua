...
M.general = {
  n = {
    ...
    ["<leader>sp"] = { ":Lspsaga peek_definition <CR>", "LspSaga peek definition", opts = { silent = true } },
    ["<leader>sP"] = { ":Lspsaga peek_type_definition <CR>", "LspSaga peek type definition", opts = { silent = true } },
    ...
    ["gl"] = { ":Lspsaga diagnostic_jump_next <CR>", "LspSaga diagnostic", opts = { silent = true } },
    ...
    ["<leader>sR"] = { ":Lspsaga project_replace <CR>", "LspSaga project replace", opts = { silent = true } },
